...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 fixed-top">
      <div class="container">
        <a href="#" class="navbar-brand">University Aspire</a>
        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a href="useraddjoke.php">Questions</a>
            </li>
            <li class="nav-item">
            <a href="admin/questions.php">Admin</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-between">
          <div>
            ...
            <a href="questions.html.php">Questions</a>
